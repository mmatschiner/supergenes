...
for z in range(len(query_window_ids)):
    ...
    if refine:
        ...
        if aln_ids != refined_aln_ids:
            for x in range(len(aln_ids)):
                if aln_ids[x][0:20] != refined_aln_ids[x][0:20]:
                    if len(aln_ids) > 2:
                        ...
                        print("ERROR: Alignment ids have changed after mafft refinement! (before: " + aln_ids[0] + ", " + aln_ids[1] + "; after:" + refined_aln_ids[0] + ", " + refined_aln_ids[1] + ".)")
                    elif len(aln_ids) > 0:
                        print("ERROR: Alignment ids have changed after mafft refinement! (before: " + aln_ids[0] + "; after:" + refined_aln_ids[0] + ".)")
                    sys.exit(1)
        ...
        for x in range(len(aln_seqs)):
            if aln_seqs[x].replace("-","").lower() != refined_aln_seqs[x].replace("-","").lower():
