...
ls -d `readlink -f ../data/subjects/`/*.fasta | grep -v "danrer" >> ../data/subjects/assemblies.txt
ls -d `readlink -f ../res/kollector/`/*.fasta >> ../data/subjects/assemblies.txt
...
do
    ...
    sbatch -o ${out} find_orthologs.slurm ${i} ../data/subjects/assemblies.txt ../res/alignments/orthologs/01/
done
