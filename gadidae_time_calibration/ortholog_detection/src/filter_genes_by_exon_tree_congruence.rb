...
info_file_name = ARGV[2]
minimum_congruent_set_size = ARGV[3].to_i
raxml_path = ARGV[4] # This must be RAxML v. 7.2.8 and it must be named "raxmlHPC"
concaterpillar_dir = ARGV[5].chomp("/")
number_of_cpus = ARGV[6].to_i
