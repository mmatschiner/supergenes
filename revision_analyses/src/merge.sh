...
do
    ...
    then
        ...
        rm -f ${out}
        sbatch -o ${out} --account ${acct} merge.slurm ../res/mapping/${ref_id}/Arcgla.bam ${ref} ${log} ../res/mapping/${ref_id}/Arcgla_ERR147388?.bam
    fi
    ...
    then
        ...
        rm -f ${out}
        sbatch -o ${out} --account ${acct} merge.slurm ../res/mapping/${ref_id}/Borsai.bam ${ref} ${log} ../res/mapping/${ref_id}/Borsai_ERR147388?.bam
    fi
    if [ ! -f ../res/mapping/${ref_id}/Gadmor_coa.bam ]
    then
        out=../log/misc/merge.${ref_id}_Gadmor_coa.out
        log=../log/misc/merge.${ref_id}_Gadmor_coa.log
        rm -f ${out}
        sbatch -o ${out} --account ${acct} merge.slurm ../res/mapping/${ref_id}/Gadmor_lfc3.bam ${ref} ${log} ../res/mapping/${ref_id}/Gadmor_lfc3_LOF1106011L00?.bam
    fi
done
